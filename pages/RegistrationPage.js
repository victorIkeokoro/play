import { generateNumber, readJsonFile, writeJsonFile } from '../utils/testUtils';
export class RegistrationPage {
    constructor(page) {
        ...
        this.registration_success = page.locator("[class='notification show success'] div");
    }
    ...
    async registerEmail() {
        ...
        jsonObject.registeredEmails.push(newData);
